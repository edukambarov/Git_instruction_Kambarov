...
Убедитесь, что вы находитесь в нужной ветке, используя уже знакомую команду **git branch**.

Аеаеаеае

Также стоит убедиться перед слиянием, что нужные изменения сохранены (закомичены) в той ветке, в которой вы внесли изменения и из которой они подтягиваются с помощью команды **merge**.